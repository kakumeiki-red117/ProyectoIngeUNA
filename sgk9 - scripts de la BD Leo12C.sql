...
--Para seleccionar codigo de secuencias de los IDENTITY de informes y actas
--INFORMES
--Select DATA_DEFAULT from USER_TAB_COLUMNS where table_name = 'INFORMES' and column_name = 'ID';
--ACTAS
--Select DATA_DEFAULT from USER_TAB_COLUMNS where table_name = 'ACTAS' and column_name = 'ID';

--luego seleccionar el nextval 
--SELECT "SGK9"."ISEQ$$_91978".nextval from dual;


--SE USA SOLAMENTE PARA ELIMINAR TODAS LAS TABLAS, EL SCHEMA, 
--EL USUARIO Y LOS TABLESPACES DE sgk9.
--PARA QUE SE ELIMINE EL USUARIO, DEBE ESTAR DESCONECTADO.
 /*
 
connect sgk9/k9sg;

DROP VIEW V_IMPUTADOS cascade constraints;
DROP VIEW V_OFENDIDOS cascade constraints;
DROP VIEW V_TESTIGOS cascade constraints;
